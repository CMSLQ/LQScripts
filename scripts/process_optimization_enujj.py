...
txt_file_path = os.environ["LQANA"] + "/optimizationCuts_enujj_MET.txt"
mc_filepath = os.environ["LQDATA"] + "/enujj_analysis/enujj_opt_MET//output_cutTable_lq_enujj_opt/analysisClass_lq_enujj_plots.root"
qcd_data_filepath = os.environ["LQDATA"] + "/enujj_analysis/enujj_qcd_opt_MET/output_cutTable_lq_enujj_opt/analysisClass_lq_enujj_QCD_plots.root"
